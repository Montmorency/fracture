...
strain_rate    = 1.e-7*(1.0/(units.fs))
...
sw_pot = Potential('IP EAM_ErcolAd', param_filename=param_file, cutoff_skin=cutoff_skin)
...
---------------------------------------------------------------------------------"""
			...
			atoms.info['label'] = 'EAM'                # Label for the status line
